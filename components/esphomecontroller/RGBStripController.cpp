...
uint32_t defaultcycleParams[][4] = { // color, speed, mode, duration (seconds)  // to do load from json config
	  {0xff0000, 200,  1,  15}, // blink red for 15 seconds
	  {0x00ff00, 200,  3, 20}, // wipe green for 20 seconds
	  {0x0000ff, 200, 11,  25}, // dual scan blue for 25 seconds
	  {0xeeeeee, 200, 29,  25}, // Blink Rainbow blue for 25 seconds
	  {0xeeeeee, 200, 32,  25}, // Chase Random for 25 seconds
	  {0xeeeeee, 200, 33,  25}, // Chase Rainbow for 25 seconds
	  {0x0000ff, 200, 42, 25}  // fireworks for 25 seconds
};
...
void RGBStripCycler::oncallback() {
	...
	cycleTicker.once<RGBStripCycler*>((double)GET_CYCLE_PARAM(pcycleParams, cycleIndex, 3), RGBStripCycler::callback, this);
	cycleIndex++;
