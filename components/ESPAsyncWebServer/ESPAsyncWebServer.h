...
#ifndef WEBSERVER_H
typedef enum {
  HTTP_AW_GET     = 0b00000001,
  HTTP_AW_POST    = 0b00000010,
  HTTP_AW_DELETE  = 0b00000100,
  HTTP_AW_PUT     = 0b00001000,
  HTTP_AW_PATCH   = 0b00010000,
  HTTP_AW_HEAD    = 0b00100000,
  HTTP_AW_OPTIONS = 0b01000000,
  HTTP_ANY     = 0b01111111,
} WebRequestMethod;
#endif
