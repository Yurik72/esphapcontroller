...
bool AsyncWebServerRequest::_parseReqHead(){
  ...
  if(m == "GET"){
    ...
    _method = HTTP_AW_POST;
  } else if(m == "DELETE"){
    _method = HTTP_AW_DELETE;
  } else if(m == "PUT"){
    _method = HTTP_AW_PUT;
  } else if(m == "PATCH"){
    _method = HTTP_AW_PATCH;
  } else if(m == "HEAD"){
    _method = HTTP_AW_HEAD;
  } else if(m == "OPTIONS"){
    _method = HTTP_AW_OPTIONS;
  }
...
const char * AsyncWebServerRequest::methodToString() const {
  ...
  else if(_method & HTTP_AW_GET) return "GET";
  else if(_method & HTTP_AW_POST) return "POST";
  else if(_method & HTTP_AW_DELETE) return "DELETE";
  else if(_method & HTTP_AW_PUT) return "PUT";
  else if(_method & HTTP_AW_PATCH) return "PATCH";
  else if(_method & HTTP_AW_HEAD) return "HEAD";
  else if(_method & HTTP_AW_OPTIONS) return "OPTIONS";
  return "UNKNOWN";
}
